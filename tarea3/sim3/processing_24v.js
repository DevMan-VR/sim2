...
const processData = (data) => {
    ...
    //console.log(prom(a2))
    a1_total_prom_sum += prom(a[0])
    a2_total_prom_sum += prom(a[1])
    a3_total_prom_sum += prom(a[2])
    a4_total_prom_sum += prom(a[3])
    a5_total_prom_sum += prom(a[4])
    a6_total_prom_sum += prom(a[5])
    a7_total_prom_sum += prom(a[6])
    a8_total_prom_sum += prom(a[7])
    a9_total_prom_sum += prom(a[8])
    a10_total_prom_sum += prom(a[9])
    a11_total_prom_sum += prom(a[10])
    a12_total_prom_sum += prom(a[11])
    a13_total_prom_sum += prom(a[12])
    a14_total_prom_sum += prom(a[13])
    a15_total_prom_sum += prom(a[14])
    a16_total_prom_sum += prom(a[15])
    a17_total_prom_sum += prom(a[16])
    a18_total_prom_sum += prom(a[17])
    a19_total_prom_sum += prom(a[18])
    a20_total_prom_sum += prom(a[19])
    a21_total_prom_sum += prom(a[20])
    a22_total_prom_sum += prom(a[21])
    a23_total_prom_sum += prom(a[22])
    a24_total_prom_sum += prom(a[23])
